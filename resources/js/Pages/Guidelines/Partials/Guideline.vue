<template>
    <div>
        <div class="flex justify-between">
            <h2 class="text-gray-700 font-bold text-2xl mr-2 flex-1">{{ guideline.score }}</h2>
                ...
                <div class="px-4 py-5 sm:p-6">
                            ...
                            <li v-for="(bullet, index) in form.bullets">
                                <div class="flex">
                                    <jet-input :id="'bullet' + bullet.id" type="text" class="flex-1 mt-1 block" v-model="bullet.body"
                                               autocomplete="body"/>
                                    <button class="text-red-600 ml-2"><TrashIcon class="h-6 w-6"/></button>
                                </div>
                                <p class="text-sm text-red-600" v-if="form.errors[`bullets.${index}.body`]">{{form.errors[`bullets.${index}.body`]}}</p>
                            </li>
                            <li>
                                <jet-secondary-button class="mt-2"><PlusCircleIcon class="w-6 h-6 mr-3" /> Add Bullet </jet-secondary-button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="my-2">
                        <ul>
                            ...
                            <li>
                                <jet-secondary-button class="mt-2"><PlusCircleIcon class="w-6 h-6 mr-3" /> Add Ticket </jet-secondary-button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gray-50 px-4 py-4 sm:px-6 text-right">
                        <!-- Footer -->
                        <jet-secondary-button @click="editing = false">Cancel</jet-secondary-button>
